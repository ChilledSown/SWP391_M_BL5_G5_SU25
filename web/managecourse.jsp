...
<body>
    ...
    <div class="dashboard-container">
        ...
        <main class="main-content">
            ...
            <a href="managetopic" class="back-btn">Back to Topics</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <c:if test="${not empty course.thumbnail_url}">
                                            <img src="<c:out value='${course.thumbnail_url}' />" alt="Course Thumbnail" style="max-width: 100px;">
                                        </c:if>
                                    ...
                                    <td>
                                        <form action="managelesson" method="get" style="display:inline;">
                                            <input type="hidden" name="topicId" value="${param.topicId}">
                                            <input type="hidden" name="courseId" value="${course.course_id}">
                                            <button type="submit" class="view-btn">View Lessons</button>
                                        </form>
                                    </td>
                                </tr>
                            </c:forEach>
            ...
            <div class="pagination">
                <c:if test="${currentPage > 1}">
                    <a href="managecourse?page=${currentPage - 1}&topicId=${param.topicId}">Previous</a>
                </c:if>
                <c:if test="${currentPage <= 1}">
                    <a class="disabled">Previous</a>
                </c:if>
                <c:forEach begin="1" end="${totalPages}" var="i">
                    <a href="managecourse?page=${i}&topicId=${param.topicId}" 
                       <c:if test="${currentPage == i}">class="active"</c:if>>${i}</a>
                </c:forEach>
                <c:if test="${currentPage < totalPages}">
                    <a href="managecourse?page=${currentPage + 1}&topicId=${param.topicId}">Next</a>
                </c:if>
                <c:if test="${currentPage >= totalPages}">
