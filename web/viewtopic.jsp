    ...
    <div class="container">
        ...
        <c:if test="${empty topic}">
            ...
            <div class="button-container">
                <a href="managetopic" class="back-btn">Back to Manage Topics</a>
            </div>
        </c:if>
        <c:if test="${not empty topic}">
            ...
            <c:choose>
                <c:when test="${not empty quizzes}">
                    ...
                    <div class="button-container">
                        <a href="managetopic?action=view&topicId=${param.topicId}&courseId=${param.courseId}" class="back-btn">Back to Lessons</a>
                        <a href="managetopic?action=view&topicId=${param.topicId}" class="back-to-topic-btn">Back to Topic</a>
                    </div>
                </c:when>
                <c:when test="${not empty lessons}">
                                ...
                                <c:when test="${not empty lessons}">
                                    <c:forEach var="lesson" items="${lessons}">
                                        <tr>
                                            ...
                                            <td>
                                                <a href="managetopic?action=view&topicId=${param.topicId}&courseId=${param.courseId}&lessonId=${lesson.lessonId}" class="action-btn">View Quizzes</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </c:when>
                    ...
                    <div class="button-container">
                        <a href="managetopic?action=view&topicId=${param.topicId}" class="back-btn">Back to Courses</a>
                        <a href="managetopic?action=view&topicId=${param.topicId}" class="back-to-topic-btn">Back to Topic</a>
                    </div>
                </c:when>
                <c:otherwise>
                                ...
                                <c:when test="${not empty courses}">
                                    <c:forEach var="course" items="${courses}">
                                        <tr>
                                            ...
                                            <td>
                                                <a href="managetopic?action=view&topicId=${param.topicId}&courseId=${course.course_id}" class="action-btn">View Lessons</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </c:when>
