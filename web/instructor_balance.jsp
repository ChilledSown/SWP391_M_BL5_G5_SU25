                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-4 sidebar">
                        <ul class="nav flex-column" id="sidebarNav">
                            ...
                            <li class="nav-item"><a href="balance" class="nav-link active">Order</a></li>
                                ...
                                <form method="get" action="${pageContext.request.contextPath}/balance">
                                    <div class="filter-row">
                                        <div class="filter-item search-item">
                                            <div class="filter-label">Search Description</div>
                                            <div class="search-input">
                                                <i class="fas fa-search"></i>
                                                <input type="text" name="searchTerm" class="form-control"
                                                       placeholder="Enter description..." value="${searchTerm}">
                                            </div>
                                        </div>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <c:forEach var="transaction" items="${transactions}">
                                    <tr>
                                        <td>
                                            <fmt:parseDate value="${transaction.orderDate}" pattern="yyyy-MM-dd" var="parsedDate" />
