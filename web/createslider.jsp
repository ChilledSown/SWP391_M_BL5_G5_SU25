...
<head>
    ...
    <title>Admin Dashboard - Create Slider</title>
        ...
        <main class="main-content">
            ...
            <div class="content-section">
                ...
                <form action="manageslider" method="post">
                    ...
                    <label>Image URL:
                        <input type="text" name="imageUrl" value="${param.imageUrl}" required>
                    </label>
                    <label>Created At:
                        <input type="text" value="Auto-generated (Current Date)" readonly>
                    </label>
                    <label>Updated At:
                        <input type="text" value="Auto-generated (Current Date)" readonly>
                    </label>
